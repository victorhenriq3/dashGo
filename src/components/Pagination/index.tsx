            ...
            <Stack direction="row" spacing="2">
                {currentPage > (1 + siblingsCount) &&  (
                    <>
                        ...
                        {currentPage > (2 + siblingsCount) && <Text color="gray.300" w="6" text-align="center">...</Text>}
                    </>
                )}
                ...
                {(currentPage  + siblingsCount) < lastPage &&  (
                    <>
                       {(currentPage + 1 + siblingsCount) < lastPage && <Text color="gray.300" w="6" text-align="center">...</Text>}
